function [TTNO] = TTNO_construct_single(A,l,num_l,n,pos)
...
if l==1 % leafs
    ...
    len = length(A);
    s = len/2;
    TTNO{1} = TTNO_construct_single(A(1:s),l-1,num_l,n(1:s),pos(1:s));
    TTNO{2} = TTNO_construct_single(A((s+1):len),l-1,num_l,n((s+1):len),pos((s+1):len));
end
