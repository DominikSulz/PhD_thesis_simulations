        ...
        function obj = hss_TT(varargin)
            ...
            if ~ischar(varargin{1})
                ...
                if issparse(A)
                    ...
                    obj = hss_build_hss_tree_TT(size(A, 1), size(A, 2), ...
            ...
            if nargin > 1
                switch varargin{1}
                    case 'banded'
                        obj = hss_build_hss_tree_TT(size(varargin{2}, 1), ...
                    ...
                    case 'diagonal'
                        obj = hss_build_hss_tree_TT(length(varargin{2}), ...
                    ...
                    case 'handle'
                        ...
                        obj = hss_build_hss_tree_TT(varargin{5}, varargin{6}, ...
                            hssoption('block-size'), rowcluster, ...
                            colcluster);
