...
r = 20*ones(1,d);  % rank of the system at the leaves
...
title('Rank-adaptive BUG')
legend('$ \vert \vert X(t) \vert \vert$','Interpreter','latex','FontSize',20)
subplot(2,3,4); plot(0:dt:T_end,abs(Energy_con_ad),'Linewidth',2)
xlabel('Time')
legend('$ < X(t) \vert H \vert X(t) > $','Interpreter','latex','FontSize',20)
